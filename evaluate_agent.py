...
def evaluate_agent(ckpt_path):
    ...
    env = LeaderboardEnv(obs_configs=obs_configs, reward_configs=reward_configs,
                    terminal_configs=terminal_configs, host='localhost', port=2014,
...
if __name__ == '__main__':
    ...
    #     ckpt_idx += 4
    # ckpt_file = pathlib.Path('/home/casa/projects/saved_runs/fake-birdview-gan/0/ckpt/ckpt_1400832.pth')
    # ckpt_file = pathlib.Path('/home/casa/projects/saved_runs/rgb-gail/1/ckpt/ckpt_663552.pth')
    # ckpt_file = pathlib.Path('/home/casa/projects/saved_runs/bc/1/ckpt/ckpt_latest.pth')
    # ckpt_file = pathlib.Path('/home/casa/projects/saved_runs/no-traj-plot/gail-gan-0/ckpt_1204224.pth')
    # ckpt_file = pathlib.Path('/home/casa/projects/saved_runs/no-traj-plot/bc-gan-3/ckpt_latest.pth')
    ckpt_file = pathlib.Path('/home/casa/projects/gail-carla2/ckpt_503808.pth')
